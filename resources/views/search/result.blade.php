...
<div class="container-fluid">
    <div class="row justify-content-between ml-4 mr-4">
        <div>
            <h3 style="font-family: 'Franklin Gothic'"><b>All Available Room</b></h3>
        </div>
        <div >
            <a href="{{route('search.index')}}" class="btn btn-primary"><h5 >Back</h5></a>
        </div>
    </div>
    <hr>
                ...
                <div class="card-body">
                    <table class="table table-striped table-dark">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                <b><th scope="row"><h5><b>{{$room->rooms_id}}</b></h5></th></b>
