            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{route('sales.total')}}">
                        ...
                        <div class="row mb-3">
                            <label for="checkin_date" class="col-md-4 col-form-label text-md-end">From Date: </label>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            <label for="checkout_date" class="col-md-4 col-form-label text-md-end">To Date: </label>
                            <div class="col-md-6">
                                <div class="input-group mb-3">
